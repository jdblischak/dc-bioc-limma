...
differential expression or not from a quick visualization, you also some
examples that are more ambiguous. Furthermore, you need a method that is more
...
continous variable. In the context of differential expression, it is a relative
