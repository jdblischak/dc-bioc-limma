...
# Download RNA-seq data from Hoban et al., 2016.
#
...
# Usage:
#
# Rscript download-fastq.R outdir ftpfile
#
...
if (length(args) != 2) {
  stop("Usage: Rscript download-fastq.R outdir ftpfile")
}
outdir <- args[1]
ftpfile <- args[2]

# For interactive testing:
# outdir <- "/project2/gilad/jdblischak/dc/fastq"
# ftpfile <- "/project2/gilad/jdblischak/dc/data/GSE75816.txt"
